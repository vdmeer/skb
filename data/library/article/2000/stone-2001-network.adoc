...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/article/2000/stone-2001-network.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/article/2000/stone-2001-network.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:article/2000/stone-2001-network.pdf[PDF]
endif::[]
