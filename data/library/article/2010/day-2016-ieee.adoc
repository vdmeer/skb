...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/article/2010/day-2016-ieee.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/article/2010/day-2016-ieee.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:article/2010/day-2016-ieee.pdf[PDF]
endif::[]
