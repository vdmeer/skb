...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/article/2010/zaman-2015-commag.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/article/2010/zaman-2015-commag.adoc[adoc]
ifdef::local[]
    ┃ local:
