...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/book/1800/frege-1893-basic_laws_of_arithmetic.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/book/1800/frege-1893-basic_laws_of_arithmetic.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:book/1800/[Folder]
endif::[]
