...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/book/1970/lakatos-1976-proofs_and_refutations.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/book/1970/lakatos-1976-proofs_and_refutations.adoc[adoc]
