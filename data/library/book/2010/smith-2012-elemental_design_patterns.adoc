...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/book/2010/smith-2012-elemental_design_patterns.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/book/2010/smith-2012-elemental_design_patterns.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:book/2010/smith-2012-elemental_design_patterns-report.pdf[PDF: Report],
        link:book/2010/smith-2012-elemental_design_patterns.pptx[PPTX]
endif::[]
