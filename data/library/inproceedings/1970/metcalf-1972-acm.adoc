...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1970/metcalf-1972-acm.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1970/metcalf-1972-acm.adoc[adoc]
ifdef::local[]
    ┃ local:
