...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1980/dobson-1989-ssp.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1980/dobson-1989-ssp.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:library/inproceedings/1980/dobson-1989-ssp.pdf[Folder]
endif::[]
