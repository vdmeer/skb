...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1980/mccarthy-1989-sigmod.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1980/mccarthy-1989-sigmod.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:library/inproceedings/1980/mccarthy-1989-sigmod.pdf[Folder]
endif::[]
