...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1980/robinson-1988-ftdcs.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1980/robinson-1988-ftdcs.adoc[adoc]
ifdef::local[]
    ┃ local:
