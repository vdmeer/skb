...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/arbanowski-1999-iscc.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/arbanowski-1999-iscc.adoc[adoc]
ifdef::local[]
    ┃ local:
