...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/pfeifer-1998-africom.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/pfeifer-1998-africom.adoc[adoc]
ifdef::local[]
    ┃ local:
