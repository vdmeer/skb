...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/sloman-1990-ftdcs.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/sloman-1990-ftdcs.adoc[adoc]
ifdef::local[]
    ┃ local:
