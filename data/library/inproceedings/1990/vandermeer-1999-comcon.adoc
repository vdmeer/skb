...
* Links:
      skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/vandermeer-1999-comcon.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/1990/vandermeer-1999-comcon.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:library/inproceedings/1990[Folder]
endif::[]
