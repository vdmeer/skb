...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/arbanowski-2000-wuc.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/arbanowski-2000-wuc.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000[Folder]
endif::[]
