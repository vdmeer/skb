...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/barrett-2003-itsrs.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/barrett-2003-itsrs.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/barrett-2003-itsrs.pdf[PDF]
endif::[]
