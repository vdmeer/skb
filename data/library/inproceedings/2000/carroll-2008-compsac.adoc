...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/carroll-2008-compsac.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/carroll-2008-compsac.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/carroll-2008-compsac.pdf[PDF],
        link:inproceedings/2000/carroll-2008-compsac.doc[DOC]
endif::[]
