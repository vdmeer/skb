...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/davy-2008-temu.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/davy-2008-temu.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/davy-2008-temu.pdf[PDF],
        link:inproceedings/2000/davy-2008-temu.doc[DOC]
endif::[]
