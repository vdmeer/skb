...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/oconnor-2003-isict.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/oconnor-2003-isict.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/oconnor-2003-isict.pdf[PDF]
endif::[]
