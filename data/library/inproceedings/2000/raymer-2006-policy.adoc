...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/raymer-2006-policy.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/raymer-2006-policy.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/raymer-2006-policy.pdf[PDF]
endif::[]
