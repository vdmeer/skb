...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/strassner-2008-compsac-b.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/strassner-2008-compsac-b.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/strassner-2008-compsac-b.pdf[PDF]
endif::[]
