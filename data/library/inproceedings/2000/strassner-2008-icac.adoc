...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/strassner-2008-icac.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/strassner-2008-icac.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/strassner-2008-icac.pdf[PDF],
        link:inproceedings/2000/strassner-2008-icac.doc[DOC]
endif::[]
