...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/strassner-2009-mace.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2000/strassner-2009-mace.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2000/strassner-2009-mace.pdf[PDF],
        link:inproceedings/2000/strassner-2009-mace.doc[DOC]
endif::[]
