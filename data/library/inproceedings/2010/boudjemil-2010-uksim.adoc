...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2010/boudjemil-2010-uksim.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2010/boudjemil-2010-uksim.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2010/boudjemil-2010-uksim.pdf[PDF],
        link:inproceedings/2010/boudjemil-2010-uksim.doc[DOC]
endif::[]
