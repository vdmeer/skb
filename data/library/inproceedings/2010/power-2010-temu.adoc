...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2010/power-2010-temu.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2010/power-2010-temu.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2010/power-2010-temu.pdf[Folder]
endif::[]
