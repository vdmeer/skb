...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2010/strassner-2010-percom.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/inproceedings/2010/strassner-2010-percom.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:inproceedings/2010/strassner-2010-percom.pdf[PDF],
        link:inproceedings/2010/strassner-2010-percom.doc[DOC]
endif::[]
