...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/project/arcfire/arcfire-d21-2016.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/project/arcfire/arcfire-d21-2016.adoc[adoc]
ifdef::local[]
    ┃ local:
