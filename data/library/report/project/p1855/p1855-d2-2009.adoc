...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/project/p1855/p1855-d2-2009.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/project/p1855/p1855-d2-2009.adoc[adoc]
ifdef::local[]
    ┃ local:
