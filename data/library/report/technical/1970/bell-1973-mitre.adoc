...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/technical/1970/bell-1973-mitre.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/technical/1970/bell-1973-mitre.adoc[adoc]
ifdef::local[]
    ┃ local:
