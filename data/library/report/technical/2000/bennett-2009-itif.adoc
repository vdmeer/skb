...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/technical/2000/bennett-2009-itif.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/report/technical/2000/bennett-2009-itif.adoc[adoc]
ifdef::local[]
    ┃ local:
        link:library/report/technical/2000[Folder]
endif::[]
