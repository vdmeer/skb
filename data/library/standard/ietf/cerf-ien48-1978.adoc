...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/standard/ietf/cerf-ien48-1978.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/standard/ietf/cerf-ien48-1978.adoc[adoc]
ifdef::local[]
    ┃ local:
