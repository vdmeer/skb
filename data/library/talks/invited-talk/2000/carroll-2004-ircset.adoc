...
* Links:
      skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/invited-talk/2000/carroll-2004-ircset.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/invited-talk/2000/carroll-2004-ircset.adoc[adoc]
ifdef::local[]
    ┃ local:
