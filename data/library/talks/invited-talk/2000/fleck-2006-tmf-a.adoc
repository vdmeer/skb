...
* Links:
      skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/invited-talk/2000/fleck-2006-tmf-a.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/invited-talk/2000/fleck-2006-tmf-a.adoc[adoc]
ifdef::local[]
    ┃ local:
