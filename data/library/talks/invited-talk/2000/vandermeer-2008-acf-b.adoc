...
* Links:
      skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/invited-talk/2000/vandermeer-2008-acf-b.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/invited-talk/2000/vandermeer-2008-acf-b.adoc[adoc]
ifdef::local[]
    ┃ local:
