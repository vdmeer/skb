...
* Links:
      skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/keynote/2010/fleck-2011-manfed.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/keynote/2010/fleck-2011-manfed.adoc[adoc]
ifdef::local[]
    ┃ local:
