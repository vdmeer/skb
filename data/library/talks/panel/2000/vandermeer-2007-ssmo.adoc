*Ghamri-Doudane, Yacine* (chair): _Seamless Service Mobility Challenges and Solutions_, 2007
...
* Links:
      skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/panel/2000/vandermeer-2007-ssmo.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/panel/2000/vandermeer-2007-ssmo.adoc[adoc]
ifdef::local[]
    ┃ local:
