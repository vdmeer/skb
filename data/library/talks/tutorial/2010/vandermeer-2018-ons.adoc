...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/tutorial/2010/vandermeer-2018-ons.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/tutorial/2010/vandermeer-2018-ons.adoc[adoc],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/tutorial/2010/vandermeer-2018-ons.bib[BiBTeX],
        link:https://github.com/vdmeer/skb/tree/master/data/library/talks/tutorial/2010/vandermeer-2018-ons-biblatex.bib[Biblatex]
ifdef::local[]
    ┃ local:
