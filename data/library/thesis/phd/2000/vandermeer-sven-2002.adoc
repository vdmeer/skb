...
* Links:
    ...
    ┃ skb:
        link:https://github.com/vdmeer/skb/tree/master/data/library/thesis/phd/2000/vandermeer-sven-2002.yaml[yaml],
        link:https://github.com/vdmeer/skb/tree/master/data/library/thesis/phd/2000/vandermeer-sven-2002.adoc[adoc]
ifdef::local[]
    ┃ local:
