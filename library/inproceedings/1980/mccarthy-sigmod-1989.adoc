...
* Links:
    ...
    ┃ skb: link:https://github.com/vdmeer/skb/tree/master/library/inproceedings/1980/mccarthy-sigmod-1989.adoc[src]
ifdef::local[]
    ┃ link:/library/inproceedings/1980/mccarthy-sigmod-1989.pdf[PDF]
endif::[]
