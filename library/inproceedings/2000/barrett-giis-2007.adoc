*Keara Barrett, Steven Davy, John Strassner, Brendan Jennings, Sven van der Meer, William Donnelly*: _A Model Based Approach for Policy Tool Generation and Policy Analysis_, 2007
