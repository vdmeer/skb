...
* Links:
    ...
    ┃ skb: link:https://github.com/vdmeer/skb/tree/master/library/inproceedings/2000/carroll-dsom-2006.adoc[src]
ifdef::local[]
    ┃ link:/library/inproceedings/2000/carroll-dsom-2006.pdf[PDF]
endif::[]
