...
* Links:
    ...
    ┃ skb: link:https://github.com/vdmeer/skb/tree/master/library/inproceedings/2000/ghamri-doudane-hpovua-2004.adoc[src]
ifdef::local[]
    ┃ link:/library/inproceedings/2000/ghamri-doudane-hpovua-2004.pdf[PDF]
    ┃ link:/library/inproceedings/2000/ghamri-doudane-hpovua-2004.ppt[PPT]
    ┃ link:/library/inproceedings/2000/ghamri-doudane-hpovua-2004.7z[7z]
endif::[]
