*Mike White, Brendan Jennings, Sven van der Meer~*: _User-Centric Adaptive Access Control and Resource Configuration for Ubiquitous Computing Environments_, 2005
