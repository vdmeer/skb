*Sumit Dawar, Enda Fallon, Tom Bennet, Sven van der Meer, John Keeney*: _An Extensible Architecture for Mobile Network Management Event Distribution and Rule Processing - A Performance Evaluation_, 2013
