*Sumit DawarSven van der MeerJohn KeeneyEnda FallonTom Bennet*: _Cloudifying Mobile Network Management: Performance Tests of Event Distribution and Rule Processing_, 2013
