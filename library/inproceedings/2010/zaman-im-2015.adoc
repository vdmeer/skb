*Faisal Zaman, Sebastian Robitzsch, Zhiguo Qu, John Keeney, Sven van der Meer, Gabriel-Miro Muntean*: _i-MagNet: A real-time intelligent framework for finding specific needles from needle stacks_, 2015
