...
* Links:
    ...
    ┃ skb: link:https://github.com/vdmeer/skb/tree/master/library/talks/tutorial/2010/ethirajulu-ons-2018.adoc[src],
            link:https://github.com/vdmeer/skb/tree/master/library/talks/tutorial/2010/ethirajulu-ons-2018.yaml[yaml]
ifdef::local[]
