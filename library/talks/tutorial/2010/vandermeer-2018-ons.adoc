...
* Links:
    ...
    ┃ skb: link:https://github.com/vdmeer/skb/tree/master/library/talks/tutorial/2010/vandermeer-2018-ons.adoc[src],
            link:https://github.com/vdmeer/skb/tree/master/library/talks/tutorial/2010/vandermeer-2018-ons.yaml[yaml],
            link:https://github.com/vdmeer/skb/tree/master/library/talks/tutorial/2010/vandermeer-2018-ons.bib[bib],
            link:https://github.com/vdmeer/skb/tree/master/library/talks/tutorial/2010/vandermeer-2018-ons-biblatex.bib[biblatex]
ifdef::local[]
